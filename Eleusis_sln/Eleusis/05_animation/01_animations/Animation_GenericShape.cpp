...
void GenericShapeAnimation::_populateDefaultStartValues()
{
...
void GenericShapeAnimation::_updateToCurrentValues()
{
    for (auto target : _animationTargets)
    {
...
void GenericShapeAnimation::clear()
{
    Animation::clear();
...
void GenericShapeAnimation::bind(GenericShape* target)
{
...
void GenericShapeAnimation::unbind(GenericShape* target)
{
    _animationTargets.remove(target);
}

void GenericShapeAnimation::registerAnimation()
{
